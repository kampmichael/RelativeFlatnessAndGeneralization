...
BatchNorm2dPartial = functools.partial(nn.BatchNorm2d, track_running_stats = False)
...
def efficientnet_b5(
    *, weights: Optional[EfficientNet_B5_Weights] = None, progress: bool = True, **kwargs: Any
    ...
    return _efficientnet(
        ...
        weights,
        progress,
        norm_layer=partial(BatchNorm2dPartial, eps=0.001, momentum=0.01),
        **kwargs,
    )
...
def efficientnet_v2_s(
    *, weights: Optional[EfficientNet_V2_S_Weights] = None, progress: bool = True, **kwargs: Any
    ...
    return _efficientnet(
        ...
        weights,
        progress,
        norm_layer=partial(BatchNorm2dPartial, eps=1e-03),
        **kwargs,
    )
